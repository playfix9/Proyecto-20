...
function setup(){
    ...
    particle6 = Bodies.circle(240,10,10,particle_options);
    ...
    particle9 = Bodies.circle(260,10,10,particle_options);
    World.add(world,particle9);
    particle10 =Bodies.circle(260,10,10,particle_options);
